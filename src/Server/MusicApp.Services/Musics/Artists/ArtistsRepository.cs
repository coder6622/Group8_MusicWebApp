...
namespace MusicApp.Services.Musics.Artists
{
    public class ArtistsRepository : IArtistsRepository
    {
        ...
        {
            return await _context.Set<Artist>().FindAsync(artistId);
        }
        
        public async Task<Artist> GetCachedArtistByIDAsync(Guid artistId)
        {
            return await _memoryCache.GetOrCreateAsync(
                ...
                async (entry) =>
                {
                    ...
                    return await GetArtistByIdAsync(artistId);
                });
        }
